...
from ..persistence import add_al_round, add_metric_time_value_to_run, format_augmentation, generate_save_locations_for_al_round, get_absolute_paths, get_most_recent_round_info, atomic_torch_save, atomic_json_save, get_all_rounds_from_run
...
class LimitedMemoryExperiment(Experiment):
    ...
    def __init__(self, comm_lock, comm_sem, parent_pipe, gpu_name, base_dataset_directory, base_exp_directory, db_loc):
        ...
        super(LimitedMemoryExperiment, self).__init__(comm_lock, comm_sem, parent_pipe, gpu_name, base_dataset_directory, base_exp_directory, db_loc)
        self.round_number = 0
    ...
    def do_al_round(self, train_dataset_name, model_architecture_name, arrival_pattern, run_number, training_loop_name, al_method_name, al_budget, init_task_size, unl_buffer_size, batch_size, num_rounds):
        ...
        if round_training_loop.epoch < 0:
            ...
            train_callback = LimitedMemoryExperimentCallback(train_dataset_name, model_architecture_name, arrival_pattern, run_number, training_loop_name, al_method_name, al_budget, init_task_size, unl_buffer_size, \
    ...
    def save_al_round(self, train_unlabeled_val_dataset_split, train_dataset_name, model_architecture_name, arrival_pattern, run_number, training_loop, 
        ...
        split_path, weight_path, opt_state_path, lr_state_path, completion_unix_time = generate_save_locations_for_al_round(train_dataset_name, model_architecture_name, 1, arrival_pattern, training_loop_name, al_method_name, run_number, al_budget, init_task_size, unl_buffer_size, round_number)
...
class LimitedMemoryExperimentCallback:
